/**
 * Teste da versão working que evita completamente fill()
 */
...
const TEST_COMMENT = `Teste working final! ${new Date().toISOString()}`;

async function testWorkingFinal() {
  console.log('='.repeat(60));
  console.log('TESTE VERSÃO WORKING - SEM FILL()');
  console.log('='.repeat(60));
...
testWorkingFinal().catch(console.error);
